...
|------|-----------------------------------------------------------|----------------------------------------------------|--------|
| 1    | Escreva um programa Java que imprima "Hello, World!" no console. | Conceitos básicos de Java, saída no console. |        |
...
| 6    | Implemente um programa Java para verificar se um número é um número primo usando um loop for. | Algoritmos de verificação em Java. |        |
...
| 11   | Crie um programa Java que use um loop foreach para imprimir todos os elementos de um array. | Uso do loop foreach em Java. |        |
...
| 50   | Escreva um programa Java que leia uma matriz e imprima a soma de cada linha. | Manipulação de matrizes em Java. |        |
| 51   | Crie um programa Java que leia uma matriz e imprima a soma de cada coluna. | Manipulação de matrizes em Java. |        |
...
| 137  | Escreva um programa Java que leia um array e verifique se é um array monotônico. | Estruturas de dados em Java. |        |
...
| 157  | Implemente um programa Java que leia duas listas de números e imprima a interseção entre elas. | Estruturas de dados em Java. |        |
| 158  | Escreva um programa Java que leia um array de números e verifique se ele é um array circularmente ordenado. | Estruturas de dados em Java. |        |
| 159  | Crie um programa Java que leia uma lista de palavras e imprima as palavras palíndromas. | Manipulação de strings em Java. |        |
| 160  | Implemente um programa Java que leia um array de números e determine o número de inversões no array. | Algoritmos de ordenação em Java. |        |
| 161  | Escreva um programa Java que leia um texto e imprima o comprimento da menor e da maior palavra. | Manipulação de strings em Java. |        |
| 162  | Crie um programa Java que leia uma matriz e determine se ela é uma matriz de magic square. | Algoritmos em Java. |        |
| 163  | Implemente um programa Java que leia um array de números e imprima os números que aparecem mais de uma vez. | Estruturas de dados em Java. |        |
| 164  | Escreva um programa Java que leia uma lista de números e calcule o produto dos números primos. | Algoritmos matemáticos em Java. |        |
